      ...
      <div class="pt-5 pb-12 md:flex md:items-center md:justify-between">
        <div class="flex space-x-6 md:order-2">
          <a v-if="$config.email" target="_blank" rel="noreferrer" :href="`mailto:${$config.email}`"
            ...
            <svg class="h-5 w-5" aria-hidden="true" fill="currentColor" viewBox="0 0 18 18">
              <path
          ...
          <a v-if="$config.social.instagram" target="_blank" rel="noreferrer"
            :href="`https://instagram.com/${$config.social.instagram}`" class="text-gray-400 hover:text-gray-300">
          ...
          <a v-if="$config.social.twitter" target="_blank" rel="noreferrer"
            :href="`https://twitter.com/${$config.social.twitter}`" class="text-gray-400 hover:text-gray-300">
          ...
          <a v-if="$config.social.github" target="_blank" rel="noreferrer"
            :href="`https://github.com/${$config.social.github}`" class="text-gray-400 hover:text-gray-300">
          ...
          <a v-if="$config.social.linkedin" target="_blank" rel="noreferrer"
            :href="`https://linkedin.com/in/${$config.social.linkedin}`" class="text-gray-400 hover:text-gray-300">
        ...
        <p class="mt-8 text-sm leading-6 text-gray-400 md:mt-0 md:order-1">
          &copy; {{ new Date().getFullYear() }} <span class="ceator-preview hover:text-hot-pink text-gray-300">
            <a class="hidden md:inline-block" rel="noreferrer" target="_blank"
              :href="`https://github.com/${$config.social.github}`">
              <creator-preview :avatar="avatar" :name="$config.name" :description="description" :content="content"
                :mode="mode" />
            </a>
            <a class="inline-block md:hidden" target="_blank" :href="`https://github.com/${$config.social.github}`">{{
            $config.name }}
            </a>
          </span>
          • {{ $config.domain }}
...
export default {
  ...
  data() {
    return {
      ...
      content: `Hey, I am Vincent 👋<br/> Hope you enjoy your visit :)`,
    }
  }
}
</script>
