<template>
  <div class="max-w-7xl pb-10 border-r border-l border-dashed border-gray-700 mx-auto">
    ...
    <div data-aos="zoom-in"
      class="max-w-4xl mx-4 border border-dashed border-gray-700 sm:mx-auto bg-gray-900 shadow-md rounded-md overflow-hidden sm:rounded-lg">
      <div v-if="$config.social.codestats"
        class="px-4 py-5 flex flex-row justify-between border-b border-indigo-600 sm:px-6">
        <div class="w-full">
      ...
      <div>
        <dl>
          <div v-for="(item, index) in $config.uses.meta" :class="index%2 === 0 ? 'bg-gray-800' : 'bg-gray-900'"
